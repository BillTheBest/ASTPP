	...
	<input name="id" value="<TMPL_VAR NAME="id">" type="hidden">
      ...
      <TMPL_LOOP NAME="configuration_list">
	       ...
	       <TD><TMPL_VAR NAME="brand"></TD>
               ...
               <TD>
                   <a href="astpp-admin.cgi?mode=Configuration&action=Edit&id=<TMPL_VAR NAME="id">"><img alt='Edit' src='../../_astpp/edit.gif'></a>
                   <a href="astpp-admin.cgi?mode=Configuration&action=Delete&id=<TMPL_VAR NAME="id">"><img alt='Delet' src='../../_astpp/delete.gif'></a>
	      </TD>
            </TR>
      </TMPL_LOOP> 
</table>
