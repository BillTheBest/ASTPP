	...
	<input name="taxes_id" value="<TMPL_VAR NAME="taxes_id">" type="hidden">
      ...
      <TMPL_LOOP NAME="taxes_list">
	       ...
	       <TD><TMPL_VAR NAME="taxes_amount"></TD>
               ...
               <TD><TMPL_VAR NAME="last_modified"></TD>         
               <TD><TMPL_VAR NAME="date_added"></TD>         
               <TD><a href="astpp-admin.cgi?mode=Taxes&action=Edit&taxes_id=<TMPL_VAR NAME="taxes_id">"><img alt='Edit' src='../../_astpp/edit.gif'></a>&nbsp;&nbsp;<a href="astpp-admin.cgi?mode=Taxes&action=Delete&taxes_id=<TMPL_VAR NAME="taxes_id">"><img alt='Delete' src='../../_astpp/delete.gif'></a>
                   </TD>
            </TR>
      </TMPL_LOOP> 
</table>
