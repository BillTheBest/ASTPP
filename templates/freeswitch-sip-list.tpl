	...
	<TMPL_LOOP NAME="device_list">
		<TR>
			...
			<TD><TMPL_VAR NAME="fs_username"></a></TD>
          		...
          		<TD><a href="astpp-admin.cgi?mode=Freeswitch(TM) SIP Devices&directory_id=<TMPL_VAR NAME="directory_id">&action=Edit..."><img alt='Edit' src='../../_astpp/edit.gif'></a></TD>
          		<TD><a href="astpp-admin.cgi?mode=Freeswitch(TM) SIP Devices&directory_id=<TMPL_VAR NAME="directory_id">&action=Delete..."><img alt='Delete' src='../../_astpp/delete.gif'></a></TD>
            </TR>
      </TMPL_LOOP>
</table>
